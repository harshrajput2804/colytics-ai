...
export function CookieConsentBanner() {
  ...
  @media (prefers-reduced-motion: reduce) {
    #cb-bar, #cb-panel, #cb-panel-overlay, .cb-toggle-track, .cb-toggle-thumb, .cb-btn {
      ...
      {/* ==================== HTML ==================== */}
      <div id="cb-bar" role="dialog" aria-modal={false} aria-label="Cookie consent">
        <div className="cb-bar-inner">
          <div className="cb-bar-text">
            <p>
              We use cookies to improve your experience on Colytics AI.{' '}
          ...
          <div className="cb-bar-actions">
            <button className="cb-btn cb-btn-secondary" id="cb-btn-customize" type="button">
              Customize
            </button>
            <button className="cb-btn cb-btn-primary" id="cb-btn-accept-all" type="button">
              Accept All
            </button>
          </div>
        </div>
      ...
      {/* Detail Panel */}
      <div id="cb-panel-overlay" style={{ display: 'none' }} role="dialog" aria-modal={true} aria-labelledby="cb-panel-title">
        <div id="cb-panel" role="document">
          <div className="cb-panel-head">
            <h3 id="cb-panel-title">Cookie Preferences</h3>
            <p>All categories are enabled by default. You can disable any non-essential category below.</p>
          </div>
          <div className="cb-panel-body">
            {/* Strictly Necessary */}
            <div className="cb-cat">
              <div className="cb-cat-info">
                <p className="cb-cat-title">Strictly Necessary</p>
                <p className="cb-cat-desc">Required for the site to function. Cannot be disabled.</p>
              </div>
              <label className="cb-toggle" aria-label="Strictly Necessary always on">
                <input type="checkbox" id="cb-tog-necessary" defaultChecked disabled />
            ...
            <div className="cb-cat">
              <div className="cb-cat-info">
                <p className="cb-cat-title">Performance / Analytics</p>
                <p className="cb-cat-desc">Helps us understand how visitors use our site.</p>
                <p className="cb-cat-tools">Google Analytics, Microsoft Clarity</p>
              </div>
              <label className="cb-toggle" htmlFor="cb-tog-analytics" aria-label="Toggle Analytics">
                <input type="checkbox" id="cb-tog-analytics" data-cat="analytics" defaultChecked />
                <span className="cb-toggle-track">
                  <span className="cb-toggle-thumb"></span>
                </span>
              </label>
            ...
            <div className="cb-cat">
              <div className="cb-cat-info">
                <p className="cb-cat-title">Marketing / Targeting</p>
                <p className="cb-cat-desc">Used for relevant ads and campaign measurement.</p>
                <p className="cb-cat-tools">Mailchimp, HubSpot, ActiveCampaign</p>
              </div>
              <label className="cb-toggle" htmlFor="cb-tog-marketing" aria-label="Toggle Marketing">
                <input type="checkbox" id="cb-tog-marketing" data-cat="marketing" defaultChecked />
                <span className="cb-toggle-track">
                  <span className="cb-toggle-thumb"></span>
                </span>
              </label>
            ...
            <div className="cb-cat">
              <div className="cb-cat-info">
                <p className="cb-cat-title">Functional</p>
                <p className="cb-cat-desc">Remembers your preferences and settings.</p>
                <p className="cb-cat-tools">Preferences, Trello, Cloudflare</p>
              </div>
              <label className="cb-toggle" htmlFor="cb-tog-functional" aria-label="Toggle Functional">
                <input type="checkbox" id="cb-tog-functional" data-cat="functional" defaultChecked />
                <span className="cb-toggle-track">
                  <span className="cb-toggle-thumb"></span>
                </span>
              </label>
            ...
            {/* CCPA */}
            <div className="cb-ccpa-line">
              <strong>California residents:</strong>
              <a id="cb-ccpa-optout">Do Not Sell or Share My Personal Information</a>
            </div>
          </div>
          <div className="cb-panel-foot">
            <button className="cb-btn cb-btn-ghost" id="cb-btn-close" type="button">
              Close
            </button>
            <button className="cb-btn cb-btn-secondary" id="cb-btn-save" type="button">
              Save Preferences
            </button>
            <button className="cb-btn cb-btn-primary" id="cb-btn-accept-panel" type="button">
              Accept All
            </button>
          </div>
        </div>
