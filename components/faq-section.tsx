...
const faqs = [
  ...
  { q: "How do you measure AI citation visibility?", a: "Colytics tracks how AI engines (ChatGPT, Gemini, Claude, Perplexity, Grok, DeepSeek, Copilot, Google AI Overviews, and Meta AI) respond to prompts relevant to your industry. We detect whether your brand, pages, or competitors are cited — then analyze the structural reasons behind each gap, including content structure, schema coverage, entity clarity, and fact density." },
  ...
  { q: "Which AI engines does Colytics track?", a: "Colytics currently tracks citations across ChatGPT, Google Gemini, Anthropic Claude, Perplexity, xAI Grok, DeepSeek, Microsoft Copilot, Google AI Overviews, and Meta AI. We continuously evaluate new engines as they become significant sources of answer traffic." },
