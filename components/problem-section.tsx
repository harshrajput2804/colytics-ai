...
export function ProblemSection() {
  return (
    <section className="enhanced-surface section-spacing bg-transparent border-t border-[#e8e8e8]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-10">
          <div className="bg-white border border-[#e8e8e8] rounded-2xl p-6 sm:p-7">
            ...
            <h3 className="heading-3 mb-2">Traditional SEO tools</h3>
            ...
            <div className="flex flex-wrap gap-2">
              {["Rank tracking", "Backlinks", "Crawls", "Technical SEO"].map((t) => (
                <span key={t} className="text-badge px-2.5 py-1 bg-[#f5f5f5] border border-[#e8e8e8] rounded-full text-[#737373] normal-case tracking-normal">{t}</span>
              ))}
            </div>
            <div className="mt-5 pt-5 border-t border-[#f0f0f0]">
              <p className="text-caption"><span className="font-semibold text-[#525252]">Blind spot:</span> Rankings, not citations.</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#e8e8e8] rounded-2xl p-6 sm:p-7">
            ...
            <h3 className="heading-3 mb-2">AI visibility monitors</h3>
            <p className="text-body mb-5">
            ...
            <div className="mt-5 pt-5 border-t border-[#f0f0f0]">
              <p className="text-caption"><span className="font-semibold text-[#525252]">Blind spot:</span> A scoreboard, no playbook.</p>
            </div>
          </div>
        </div>

        <div className="bg-[#0a0a0a] border border-[#0a0a0a] rounded-2xl p-7 md:p-8 text-white">
          <p className="section-label text-white/40 mb-4">Five blind spots</p>
          <ul className="grid gap-3 md:grid-cols-2 text-ui-md text-white">
            {[
